  ...
  return (
    <div className='sidebar'>
      <div className='invoice-button'>
        <span className='text-invoice'>GENERATE INVOICE</span>
      </div>
      ...
      <div className='main-submenu'>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Overview</span></span>
      </div>
      ...
      <div className='main-submenu'>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>All Payments</span></span>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Reconcilled Payments</span></span>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Un-Reconcilled Payments</span></span>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Manual Settlements</span></span>
      ...
      <div className='main-submenu'>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>All Orders</span></span>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Pending Orders</span></span>
        ...
        <span className='overview'>
          ...
          <span className='mg-left'>Reconcilled Orders</span></span>

        <span className='overview mg-top'>
          <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className='mg-left'>Merchant Profile</span></span>
